...
function Index() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const url = new URL('/admin/specialization/data', base_url);
    ...
    function handleEditClick(data) {
        router.get("/admin/specialization/edit/"+data);
    }
    ...
    function handleStatusClick(data) {
        router.get("/admin/specialization/status/"+data);
    }
        ...
        <>
            ...
            <div className="panel flex items-center overflow-x-auto whitespace-nowrap p-3 ">
                ...
                <div className="ml-auto flex justify-center items-center gap-3">
                    <Link
                        href={`${base_url}/admin/specialization/create`}
                        method="get"
            ...
            <DeleteModal isDeleteNoteModal = {isDeleteNoteModal} setIsDeleteNoteModal={setIsDeleteNoteModal} fileToDelete={fileToDelete} name="Specialization" route="specialization"></DeleteModal>
        </>
    );
}
